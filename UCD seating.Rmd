...
Both variables are categorical in this data. The variables that we are focusing on are major(liberal or non-liberal) and seat (front, back or middle). I used a bar graph to indicate the data. The numerical tool used is the cross table chart and the inferential method used is the Chi-squared test.
